...
El mundo de la impresora 3D como todo de la tecnología ha cambiado mucho en los últimos tiempos el año pasado aparecieron impresora mucho más autónoma a un precio bastante reducido y que permiten imprimir desde el móvil modelo que ya están preparados y directamente para ser impreso eso sí dependemos completamente del fabricante en todos los aspectos son modelos seleccionados personalizado y adaptado para su propia impresora y que con ello consigue una mayor calidad y facilidad de uso

Por un lado ganamos en facilidad y por otro lado perdemos el posibilidades y versatilidad de uso

Si eres el afortunado poseedor de una impresora para mular o una creality X1 o K1 está de suerte para poder hacer vas a poder imprimir con mucha más facilidad los modelos que estos fabricantes seleccione

Pero si quieres tú elegir los modelos elegir la calidad por realizar el proceso manualmente porque de lo que se trata es de aprender a hacerlo tú mismo no que te lo hagas el fabricante va a necesitar los contenidos de este curso

Aunque tu impresora estén entre estas más modernas te recomiendo que al menos revise los materiales para hacer el proceso manualmente por si llega un momento en el que necesita imprimir algo que el fabricante no ha pensado y quiere imprimir
